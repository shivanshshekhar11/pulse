...
import {
  Terminal, Mail, Lock, Eye, EyeOff, ArrowRight, Check,
} from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <div className="rounded-lg border border-border bg-surface-1 overflow-hidden mb-8">
          <div className="px-3 py-2 border-b border-border flex items-center gap-2">
            ...
            <span className="ml-3 font-mono text-[10.5px] text-muted-foreground">~/acme-corp/novapay</span>
          </div>
          <pre className="p-4 font-mono text-[12px] leading-relaxed text-muted-foreground">
            ...
            <span className="text-primary">on </span><span className="text-foreground">checkout-redesign-v2</span><span className="text-dim"> · 25%</span>{'\n'}
            <span className="text-primary">on </span><span className="text-foreground">pricing-cta-text</span><span className="text-dim"> · 100%</span>{'\n'}
            <span className="text-warning">off</span><span className="text-foreground"> homepage-hero-v3</span><span className="text-dim"> · 0%</span>{'\n\n'}
