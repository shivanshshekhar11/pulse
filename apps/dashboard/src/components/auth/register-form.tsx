      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-10 min-w-0">
        <Link href="/" className="flex items-center gap-2 self-start mb-12">
          ...
          <div className="font-mono leading-none">
            <div className="text-[16px] tracking-tight">
              pulse<span className="text-primary cursor-blink">_</span>
            </div>
        ...
        <div className="max-w-[420px] w-full">
          ...
          <div className="grid grid-cols-2 gap-2 mb-5">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-2.5 rounded-md border border-border bg-surface-1 hover:bg-surface-2 transition-colors text-[12.5px]"
            >
          ...
          <form className="space-y-4">
            <Field label="full name" required>
              <Input
                ...
                prefix={<UserIcon className="size-3.5 text-muted-foreground" />}
              />
            </Field>
            ...
            <Field label="password" required hint="min 12 characters">
              ...
              {password && (
                <div className="mt-2 space-y-1.5">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-mono text-[10px] text-muted-foreground ml-1.5 w-12 text-right">
                      {strength.label}
                    </span>
                  </div>
                </div>
  ...
  return (
    <div className="hidden lg:flex w-[480px] xl:w-[560px] border-l border-border bg-surface-0 flex-col p-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-dim mb-3">
          // why pulse
        </div>
        <h2 className="text-[22px] leading-tight mb-8 max-w-[380px]">
          <span className="gradient-text">feature flags</span> that ship at
          the speed of your terminal.
        </h2>
        ...
        <div className="rounded-lg border border-border bg-surface-1 overflow-hidden mb-8">
          ...
          <pre className="p-4 font-mono text-[12px] leading-relaxed text-muted-foreground">
            <span className="text-primary">$</span> pulse list --env=staging
            {'\n'}
            <span className="text-dim">→ 47 flags · sse @ 12ms</span>
            {'\n\n'}
            <span className="text-primary">on </span>
            <span className="text-foreground">checkout-redesign-v2</span>
            <span className="text-dim"> · 25%</span>
            {'\n'}
            <span className="text-primary">on </span>
            <span className="text-foreground">pricing-cta-text</span>
        ...
        <ul className="space-y-3">
          {[
            ...
            'terminal-first DX with first-class CLI + SDKs',
...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-4">
      <path
        fill="currentColor"
        d="M21.35 11.1H12v3.2h5.35c-.23 1.4-1.62 4.1-5.35 4.1-3.22 0-5.85-2.66-5.85-5.95 0-3.29 2.63-5.95 5.85-5.95 1.83 0 3.06.78 3.76 1.45l2.56-2.47C16.9 3.95 14.7 3 12 3 6.94 3 2.85 7.04 2.85 12s4.09 9 9.15 9c5.28 0 8.78-3.7 8.78-8.92 0-.6-.06-1.06-.13-1.48z"
      />
    </svg>
  );
}
